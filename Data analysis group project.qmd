---
title: "Report on Body mass index(BMI) distribution"
author: "William Lang"
execute: 
  echo: false
  eval: true
...
Body mass index(BMI) is an important variable in determing how healthy an indivdual is and is affected by such variables as diet and exercise. The following report will answer the questions of intrest:
...
Therefore we can clearly see that the mean and median BMI has increased over the years from 2013-2016. We can also see that the variation has also increased from 2014-2016.
...
We can now assess the fit of our model. First, we obtain our fitted values and residuals:
...
We can then plot the residuals for each year to test our assumptions:
